package com.initsrc.dev.webssh.service.impl;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.initsrc.dev.webssh.constant.ConstantPool;
import com.initsrc.dev.webssh.pojo.SSHConnectInfo;
import com.initsrc.dev.webssh.pojo.WebSSHData;
import com.initsrc.dev.webssh.service.WebSSHService;
...
public class WebSSHServiceImpl implements WebSSHService {
    ...
    public void recvHandle(String buffer, WebSocketSession session) throws IOException {
        ...
        } else if(ConstantPool.WEBSSH_OPERATE_LOGOUT.equals(webSSHData.getOperate())){
            logger.info("断开连接");
            close(session);
        } else {
            logger.error("不支持的操作");
